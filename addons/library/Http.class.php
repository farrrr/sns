...
{//類定義開始
     ...
     * @access public
     +----------------------------------------------------------
     * @param string $remote 遠端檔名
     * @param string $local 本地儲存檔名
     +----------------------------------------------------------
     * @return mixed
     +----------------------------------------------------------
     */
     ...
     * @param string $showname 下載顯示的檔名
     * @param string $content  下載的內容
     * @param integer $expire  下載內容瀏覽器快取時間
     +----------------------------------------------------------
     * @return void
     +----------------------------------------------------------
