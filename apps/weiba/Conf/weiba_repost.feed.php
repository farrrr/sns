<feed app='weiba' type='weiba_repost' info='微吧轉發'>
    <title>
        <![CDATA[{$actor} ]]>
    </title>
    <body>
        ...
        <dl class="comment">
            ...
            <dd>
                ...
                <a href="javascript:void(0)" class="ico-details" event-node ='loadPost' event-args='feed_id={$feedid}&post_id={$app_row_id}' id="{$feedid}"><!--檢視全文--></a>
